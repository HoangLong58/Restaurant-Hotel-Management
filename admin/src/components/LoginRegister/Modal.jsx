...
const Modal = ({ showModal, setShowModal, type }) => {
    ...
    const handleSendEmail = (e) => {
        const updateEmployeeOtpEmail = async () => {
            try {
                const updateEmployeeOtpRes = await EmployeeService.updateEmployeeOtpByEmail({
                    employeeEmail: email
                });
                if (!updateEmployeeOtpRes) {
                    // Toast
                    const dataToast = { message: updateEmployeeOtpRes.data.message, type: "warning" };
                ...
                setIsFillKey(true);
                // Toast
                const dataToast = { message: updateEmployeeOtpRes.data.message, type: "success" };
                showToastFromOut(dataToast);
                return;
            }
            catch (err) {
    ...
    const handleSendPhoneNumber = (e) => {
        const updateEmployeeOtpPhoneNumber = async () => {
            try {
                const updateEmployeeOtpPhoneNumberRes = await EmployeeService.updateEmployeeOtpByPhoneNumber({
                    employeePhoneNumber: phoneNumber
                });
                if (!updateEmployeeOtpPhoneNumberRes) {
                    // Toast
                    const dataToast = { message: updateEmployeeOtpPhoneNumberRes.data.message, type: "warning" };
                    showToastFromOut(dataToast);
                    return;
                }
                // Success
                ...
                setIsFillKey(true);
                // Toast
                const dataToast = { message: updateEmployeeOtpPhoneNumberRes.data.message, type: "success" };
                showToastFromOut(dataToast);
                return;
            } catch (err) {
                // Toast
    ...
    const handleAuthenKey = (e) => {
        ...
        const updateEmployeePasswordWithOtp = async () => {
            try {
                const updateEmployeePasswordRes = await EmployeeService.updateEmployeePasswordByEmail({
                    employeeEmail: email,
                    employeeOtp: key,
                    employeePassword: password
                });
                if (!updateEmployeePasswordRes) {
                    // Toast
                    const dataToast = { message: updateEmployeePasswordRes.data.message, type: "warning" };
                    showToastFromOut(dataToast);
                    return;
                }
                // Success
                ...
                setIsSuccess(true);
                // Toast
                const dataToast = { message: updateEmployeePasswordRes.data.message, type: "success" };
                showToastFromOut(dataToast);
                return;
            } catch (err) {
                // Toast
        ...
        const updateEmployeePasswordWithOtpPhoneNumber = async () => {
            try {
                const updateEmployeePasswordWithOtpPhoneNumberRes = await EmployeeService.updateEmployeePasswordByPhoneNumber({
                    employeePhoneNumber: phoneNumber,
                    employeeOtp: key,
                    employeePassword: password
                });
                if (!updateEmployeePasswordWithOtpPhoneNumberRes) {
                    // Toast
                    const dataToast = { message: updateEmployeePasswordWithOtpPhoneNumberRes.data.message, type: "warning" };
                    showToastFromOut(dataToast);
                    return;
                }
                // Success
                ...
                setIsSuccess(true);
                // Toast
                const dataToast = { message: updateEmployeePasswordWithOtpPhoneNumberRes.data.message, type: "success" };
                showToastFromOut(dataToast);
                return;
            } catch (err) {
                // Toast
        ...
        if (isEmailWay) {
            updateEmployeePasswordWithOtp();
        } else {
            updateEmployeePasswordWithOtpPhoneNumber();
        }
    }
