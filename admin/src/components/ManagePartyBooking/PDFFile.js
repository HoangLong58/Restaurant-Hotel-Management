    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.header} fixed>Thống kê doanh thu Đặt tiệc từng Quý năm 2022</Text>
                <Table
                    data={[
                        {
                            stt: 1,
                ...
                <Text style={styles.header} fixed> Biểu đồ thống kê doanh thu Đặt tiệc từng Quý năm 2022</Text>
