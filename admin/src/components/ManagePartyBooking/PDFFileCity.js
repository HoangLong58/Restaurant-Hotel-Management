    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.header} fixed>Thống kê 5 Thành phố có doanh thu Đặt tiệc cao nhất các Quý 2022</Text>
                <Table
                ...
                <Text style={styles.header}> Biểu đồ thống kê 5 Thành phố có doanh thu Đặt tiệc cao nhất các Quý 2022</Text>
