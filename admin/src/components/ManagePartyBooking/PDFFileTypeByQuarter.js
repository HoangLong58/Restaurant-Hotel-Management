    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.header} fixed>Thống kê doanh thu Đặt tiệc của các Loại tiệc trong Quý {quarter} năm 2022</Text>
                <Table
                    data={dataArray}
                >
                    <TableHeader>
                    ...
                    <TableBody>
                        <DataTableCell getContent={(r) => r.totalData.party_booking_type_name} />
                        <DataTableCell getContent={(r) => r.totalData.monthFirst} />
                        <DataTableCell getContent={(r) => r.totalData.monthSecond} />
                        <DataTableCell getContent={(r) => r.totalData.monthThird} />
                        <DataTableCell getContent={(r) => r.totalData.canam} />
                    </TableBody>
                </Table>
                <Image style={styles.image} src={props.image} />
                <Text style={styles.header}> Biểu đồ thống kê doanh thu Đặt tiệc của các Loại tiệc trong Quý {quarter} năm 2022</Text>
                <Table
                    data={dataTable}
                >
                    <TableHeader>
