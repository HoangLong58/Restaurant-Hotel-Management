    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.header} fixed>Thống kê doanh thu Đặt bàn từng tháng trong Quý {quarter} năm 2022</Text>
                <Table
                ...
                <Text style={styles.header} fixed> Biểu đồ thống kê doanh thu Đặt bàn từng tháng trong Quý {quarter} năm 2022</Text>
