...
const EmployeeRight = ({ reRenderData, setReRenderData }) => {
    // Thứ ngày tháng
    let today = new Date();
    ...
    console.log("Số lượng nhân viên: ", employeeQuantity);
            ...
            <SalesAnalytics>
                ...
                <Item className="online">
                    ...
                    <ItemRight>
                        ...
                        <h3 className="success" style={{ fontSize: "1.2rem" }}>{employeeQuantity}</h3>
                    </ItemRight>
                </Item>
