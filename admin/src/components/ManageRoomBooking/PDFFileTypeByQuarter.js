    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.header} fixed>Thống kê doanh thu Đặt phòng của các Loại phòng trong Quý {quarter} năm 2022</Text>
                <Table
                    data={dataArray}
                >
                    <TableHeader>
                    ...
                    <TableBody>
                        <DataTableCell getContent={(r) => r.roomTypeName} />
                ...
                <Text style={styles.header}> Biểu đồ thống kê doanh thu Đặt phòng của các Loại phòng trong Quý {quarter} năm 2022</Text>
                <Table
                    data={dataTable}
                >
                    <TableHeader>
