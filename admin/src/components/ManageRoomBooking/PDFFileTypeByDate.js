    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.header} fixed>Thống kê doanh thu Đặt phòng của các Loại phòng từ ngày {dateFrom} đến {dateTo} dựa vào doanh thu cả năm 2022</Text>
                {
                        ...
                        return (
                            <>
                                ...
                                >
                                    ...
                                    <TableBody>
                                        <DataTableCell getContent={(r) => r.totalData.room_type_name} />
                ...
                <Text style={styles.header}> Biểu đồ thống kê doanh thu Đặt phòng của các Loại phòng từ ngày {dateFrom} đến {dateTo} dựa vào doanh thu cả năm 2022</Text>
                <Table
                    data={dataTable}
                >
                    <TableHeader>
