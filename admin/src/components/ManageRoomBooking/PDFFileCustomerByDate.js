    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.header} fixed>Thống kê doanh thu Đặt phòng của Khách hàng từ ngày {dateFrom} đến {dateTo} dựa vào doanh thu cả năm 2022</Text>
                {
                    dataArray.map((data, key) => {
                        const dataArrayItem = data.dataArray;
                        const arrayShow = [];
                        arrayShow.push(dataArrayItem);
                        return (
                            <>
                ...
                <Text style={styles.header}> Biểu đồ thống kê doanh thu Đặt phòng của Khách hàng từ ngày {dateFrom} đến {dateTo} dựa vào doanh thu cả năm 2022</Text>
                <Table
                    data={dataTable}
                >
                    <TableHeader>
