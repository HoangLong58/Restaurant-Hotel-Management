            ...
            <SectionProgressBigger className="section z-bigger">
                <SectionProgressContainer className="container">
                    <SectionProgressRow className="row">
                        <SectionProgressCol4 className={props.step === "findDayAndRoom" ? "col-lg-4 active" : "col-lg-4"}>1. Chọn ngày và Chọn phòng</SectionProgressCol4>
                        <SectionProgressCol4 className={props.step === "payment" ? "col-lg-4 active" : "col-lg-4"}>2. Thanh toán</SectionProgressCol4>
                        <SectionProgressCol4 className={props.step === "finish" ? "col-lg-4 active" : "col-lg-4"}>3. Hoàn thành</SectionProgressCol4>
                    </SectionProgressRow>
